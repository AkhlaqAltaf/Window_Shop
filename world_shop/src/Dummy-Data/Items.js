...
function Items() {
    ...
    //     {itemID:1,businessID:1,category:"Laptop",name:"Dell Latitude 5400",frontImage:"ItemsImage/LaptopLatitude.webp",price:"42000",importants:"Condetion: Slightly Used – 9/10 without box"
...
<div class="card-container">
  <div class="card u-clearfix">
    <div class="card-body">
      ...
      <img src={ref.frontImage} alt="" class="card-media" />
      ...
      <div id="buttons">
        <Link to="/visit" id="location" state={{
          data:ref
        }}>
